...
class GameObjectHandler:
    ...
    def set_b2_scale(self, scale):
        """
        box-2d scaling; pixels per meter
        """
        self.b2_scale = scale

    def update(self):
        """
        updates physics engine, then if game objects have physics update position in world space, finally all active game objects are updated
        """
    ...
    def get_images(self):
        """
        creates a list of all the game objects images
        """
        images = []
    ...
    def get_rects(self):
        """
        creates a list of all the game objects rectangle's
        """
        rects = []
        for game_object in self.game_objects:
    ...
    def get_angles(self):
        """
        creates a list of game objects rotations
        """
        angles = []
        for game_object in self.game_objects:
    ...
    def get_game_object_of_type(self, type_of):
        """
        searches game object list for specified type
        """
        for game_object in self.game_objects:
    ...
    def add(self, game_object):
        """
        appends game objects to a list of game objects, and if necacarry adds them to box 2d for physics handle
        """

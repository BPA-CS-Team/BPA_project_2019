...
def load_map(path):  # loads  tmx tile map
    """
    :param path:
    :return: returns list of game_objects loaded from tile map
    """
    ...
    for layer in tiled_map.layers:  # iterates through all layers of the tile map
        ...
        for x, y, image in layer.tiles():  # iterates through tiles in layer
            ...
            game_object = class_name(x*tiled_map.tilewidth, y*tiled_map.tileheight, image) # game_object is an instance of class_name
